...
export default function HomePage() {
  return (
    <>
      ...
      >
        ...
        <div className="container-custom relative z-10 py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-bold text-white uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-6">
                Top-Quality Insulation Solutions in Seminole, TX
              </h1>
              <p className="text-gray-200 text-sm md:text-[15px] tracking-[1px] md:tracking-[2px] leading-[1.8] mb-8">
              ...
              <Link
                href="/contact-us/"
                className="inline-block bg-[#46276A] hover:bg-tan-gold text-white font-bold uppercase text-sm md:text-base tracking-[2px] md:tracking-[3px] px-5 md:px-6 py-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
      ...
      {/* Purple Divider */}
      <div className="h-12 md:h-16 bg-purple-dark" />

      {/* SECTION 1: Insulation Tailored - Image left with box-shadow, text right */}
      <section className="py-16 md:py-[120px] overflow-hidden">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Left: Image with purple box-shadow offset */}
            <ScrollAnimation direction="left" className="relative flex justify-center lg:justify-start">
              <motion.div
                className="relative inline-block"
                style={{ boxShadow: '-15px -15px 0px 0px #46276A' }}
              ...
              >
                <Image
                  ...
                  width={440}
                  height={744}
                  className="w-full max-w-[350px] md:max-w-[440px] h-auto"
                />
              </motion.div>
            </ScrollAnimation>
            ...
            <ScrollAnimation direction="right" delay={0.2}>
              <h4 className="text-tan-gold text-xs md:text-[14px] font-medium uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-4">
                Exceptional Service and Results
              </h4>
              <h2 className="text-2xl md:text-[34px] font-bold text-[#333333] uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-5">
                Insulation Tailored to Your Needs
              </h2>
              <p className="text-[#A6A6A6] text-sm md:text-[15px] tracking-[1px] md:tracking-[2px] leading-[1.8] mb-8">
              ...
              <Link
                href="/contact-us/"
                className="inline-block bg-[#46276A] hover:bg-tan-gold text-white font-bold uppercase text-sm md:text-base tracking-[2px] md:tracking-[3px] px-4 py-2.5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
                Contact Us
              </Link>
            </ScrollAnimation>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <ScrollAnimation direction="left">
              ...
              <h4 className="text-tan-gold text-xs md:text-[14px] font-medium uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-6">
                Transform Your Space for Lasting Comfort and Efficiency
              </h4>
              <p className="text-[#A6A6A6] text-sm md:text-[15px] tracking-[1px] md:tracking-[2px] leading-[1.8]">
            ...
            <StaggerContainer className="space-y-6 md:space-y-8" staggerDelay={0.15}>
              <StaggerItem>
                <motion.div
                  className="flex gap-4 items-start p-4 rounded-lg hover:bg-white hover:shadow-md transition-all duration-300"
                  whileHover={{ x: 10 }}
                >
                  <div className="flex-shrink-0">
                    <svg className="w-8 h-8 md:w-10 md:h-10 text-purple-dark" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="container-custom">
          <ScrollAnimation>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 md:mb-12">
              <div>
                <h2 className="text-2xl md:text-[34px] font-bold text-[#333333] uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-2">
                  Our 3-Step Process
                </h2>
                <h4 className="text-tan-gold text-xs md:text-[14px] font-medium uppercase tracking-[3px] md:tracking-[5px] leading-[1.3]">
                  How It Works
              ...
              <Link
                href="/contact-us/"
                className="inline-block bg-[#46276A] hover:bg-tan-gold text-white font-bold uppercase text-sm md:text-base tracking-[2px] md:tracking-[3px] px-4 py-2.5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg mt-4 md:mt-0 w-fit"
              >
                Get Started
              </Link>
            </div>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8" staggerDelay={0.2}>
            ...
            <StaggerItem>
              ...
              >
                ...
                >
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-purple-dark/10 flex items-center justify-center">
                    <svg className="w-10 h-10 md:w-12 md:h-12 text-purple-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                  </div>
                </motion.div>
                <h3 className="text-lg md:text-xl font-bold text-[#333333] uppercase tracking-[2px] md:tracking-[3px] mb-3">
                  Step 1: Consultation
                </h3>
                <p className="text-[#A6A6A6] text-sm md:text-[15px] tracking-[1px] leading-[1.8]">
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] overflow-hidden">
        ...
        {/* Content */}
        <div className="container-custom relative z-10 py-12 md:py-20 flex items-center min-h-[500px] md:min-h-[600px]">
          {/* Semi-transparent purple card */}
          <ScrollAnimation direction="left">
            <motion.div
              className="bg-purple-dark/90 py-8 md:py-12 px-6 md:px-8 lg:px-12 max-w-xl backdrop-blur-sm"
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
            >
              <h4 className="text-tan-gold text-xs md:text-[14px] font-medium uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-4">
              ...
              <h2 className="text-2xl md:text-[34px] font-bold text-white uppercase tracking-[3px] md:tracking-[5px] leading-[1.3] mb-6">
                Introducing Desert Spray Foaming
              </h2>
              <p className="text-gray-300 text-sm md:text-[15px] tracking-[1px] md:tracking-[2px] leading-[1.8] mb-8">
              ...
              <Link
                href="/contact-us/"
                className="inline-block bg-tan-gold hover:bg-white hover:text-purple-dark text-white font-bold uppercase text-sm md:text-base tracking-[2px] md:tracking-[3px] px-5 md:px-6 py-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
                Get In Touch
              </Link>
            </motion.div>
      ...
      <section className="py-16 md:py-20 bg-purple-dark overflow-hidden">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            {/* Right: Google Map */}
            <ScrollAnimation direction="right" delay={0.2}>
              <div className="bg-white min-h-[350px] md:min-h-[450px] rounded-lg overflow-hidden shadow-2xl">
                <iframe
